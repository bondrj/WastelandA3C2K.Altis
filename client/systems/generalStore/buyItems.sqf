...
storePurchaseHandle = _this spawn
{
	...
	{
		_itemText = _this select 0;
		hint parseText format ["<t color='#ffff00'>The purchase of this item is only<br/>available to community supporters.</t><br/>Learn how to become a support member by visiting the forum at clanc2k.com.br", _itemText];
		playSound "FD_CP_Not_Clear_F";
		_price = -1;
	};
